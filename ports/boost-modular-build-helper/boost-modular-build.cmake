function(boost_modular_build)
    ...
    elseif(CMAKE_HOST_WIN32 AND NOT VCPKG_TARGET_ARCHITECTURE STREQUAL "x64" AND NOT VCPKG_TARGET_ARCHITECTURE STREQUAL "x86" AND NOT VCPKG_TARGET_ARCHITECTURE STREQUAL "s390x")
        get_filename_component(BOOST_BUILD_PATH "${CURRENT_INSTALLED_DIR}/../x86-windows/tools/boost-build" ABSOLUTE)
    else()
    ...
    elseif(VCPKG_PLATFORM_TOOLSET MATCHES "external")
        if(VCPKG_TARGET_ARCHITECTURE STREQUAL "arm64")
            list(APPEND B2_OPTIONS toolset=gcc-arm)
        else()
